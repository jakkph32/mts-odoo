 ...
 * @property {function} onMessengerRecipientAdded
...
export class MessengerRecipient extends Component {
    ...
    //static props = ["thread", "recipient", "onMessengerRecipientAdded"];
    ...
    onChangeCheckbox(ev) {
        ...
        if (this.props.recipient.checked && !this.props.recipient.persona) {
            ...
            this.dialogService.add(FormViewDialog, {
                ...
                onRecordSaved: () => this.props.onMessengerRecipientAdded(thread),
