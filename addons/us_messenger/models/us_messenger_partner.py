...
class UsMessengerPartner(models.Model):
    ...
    is_hide = fields.Boolean(related='bot_id.is_hide_change_operator_user',string='Hide button "Change Operator" for operators',
    ...
    def action_change_operator(self):
        operators = self.sudo().bot_id.operator_ids.ids
        return {
